...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--test", type=bool, default=False, help="whether to calculate PE"
    )
    parser.add_argument(
        "--config", type=str, required=True, help="The configuration file path."
    )
    parser.add_argument("opts", default=None, nargs=argparse.REMAINDER)
    parser.add_argument(
        "--train_subset", type=bool, default=False, help="whether to use Full train set"
    )
...
def set_cfg(cfg):
    ...
    cfg.dataset.pos_encoder = "None"
    cfg.dataset.pos_encoder_preprocess = True
